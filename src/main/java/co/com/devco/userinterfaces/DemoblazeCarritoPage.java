...
public class DemoblazeCarritoPage {
	...
	public static final Target LINK_DELETE_PRODUCTOS_CARRITO = Target.the("Link para borrado de productos del carrito").locatedBy("//tbody[@id='tbodyid']/tr//a[text()='Delete']");
