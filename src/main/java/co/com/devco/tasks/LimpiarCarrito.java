...
import co.com.devco.interactions.ClickVariosElementos;
import net.serenitybdd.screenplay.Actor;
import net.serenitybdd.screenplay.Performable;
import net.serenitybdd.screenplay.Task;
import net.serenitybdd.screenplay.actions.Click;

import static co.com.devco.userinterfaces.DemoblazeCarritoPage.LINK_DELETE_PRODUCTOS_CARRITO;
...
public class LimpiarCarrito implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                ClickVariosElementos.on(LINK_DELETE_PRODUCTOS_CARRITO),
                Click.on(LINK_HOME)
        );
    }
}
